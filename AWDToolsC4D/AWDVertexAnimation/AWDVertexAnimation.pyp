...
PLUGIN_ID = 1030484    #ID for the tag
...
class AWDVertexAnimationTagXpression(plugins.TagData):
    firstFrame=0
    lastFrame=50
    curRange=0
    curMode=1054
    ...
    def GetDEnabling (self, node, id, t_data, flags, itemdesc):
        #disable the stitchFinalFrame for now
...
if __name__ == "__main__":
    ...
    plugins.RegisterTagPlugin(id=PLUGIN_ID, str="AWD Vertex Animation", g=AWDVertexAnimationTagXpression, description="AWDVertexAnimationTag", icon=bmp, info=c4d.TAG_MULTIPLE|c4d.TAG_VISIBLE)